...
function Pacientes() {
  ...
  return (
    <div className="rectangulo-superior">
      <div className="pacientes-container"> {/* Contenedor principal para la página de pacientes */}
        <aside className="sidebar">
          ...
          <nav className="sidebar-nav">
            <button onClick={() => navigate('/pacientes')} disabled> {/* Botón deshabilitado porque ya estás en esta ruta */}
